                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Text(auth.auth.currentUser!.displayName??'',style: GoogleFonts.montserrat(color:Colors.black,fontSize: 17),),
                        //  spacingHeight(10),
                        // Text(auth.auth.currentUser!.email!,style:GoogleFonts.montserrat(color: Colors.black,fontSize: 15,fontWeight: FontWeight.w600)),
                        // spacingHeight(10),
